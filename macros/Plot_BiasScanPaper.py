...
parser.add_option('--xmin', dest='xmin', default = 100.0, help="Limit x-axis in final plot")
parser.add_option('--xmax', dest='xmax', default = 400.0, help="Limit x-axis in final plot")
parser.add_option('-y','--ylength', dest='ylength', default = 220.0, help="Max TimeResolution value in final plot")
...
all_histoInfos = [
  [
      HistoInfo("dt_vs_BV", inputfile, "dt_vs_BV", "Name", xMin=xmin, xMax=xmax, yMin=0.0, yMax=ylength, title="", ylabel="Time resolution [ps]", color=ROOT.kBlack,   unit=1000.0, doGaus=True, rm_photek=True),
  ]
    # [
