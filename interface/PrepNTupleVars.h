...
private:
    ...
    {     
        ...
        utility::remapToLGADgeometry(tr, corrAmp, "ampLGAD");
    }
    ...
    void prepNTupleVars(NTupleReader& tr)
    {
        ...
        // Adding tracking stuff but this is just temp
        tr.registerDerivedVar("ntracks", 1);
        tr.registerDerivedVar("ntracks_alt", 1);
        tr.registerDerivedVar("nplanes", 100);
        tr.registerDerivedVar("npix", 100);
...
public:
    ...
    {
        std::cout<<"Running PrepNTupleVars Module"<<std::endl;
    }
